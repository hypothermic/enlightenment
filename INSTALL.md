...
This document contains the build and installation instructions for Enlightenment.
...
If this guide does not help you resolve the issue, please contact <provider-name> <Enlightenment@<vendor>.com>.
